...
namespace Server
{
    public class ServerSimulator
    {
        ...
        {
            var server = new SequentialServer();
            server.start();
        ...
        internal sealed class SocketEventListener : EventListener
        {
            ...
            protected override void OnEventWritten(EventWrittenEventArgs eventData)
            {
                ...
                var sb = new StringBuilder().Append(
                    $"{eventData.TimeStamp:HH:mm:ss.ff}  {eventData.ActivityId}.{eventData.RelatedActivityId} {eventData.EventSource.Name}.{eventData.EventName} {eventData.Task}.{eventData.Message}(");
